//wheelOfFortune_6.js   The purpose here is to create a js file that picks an answer at rando and displays the corresponding board on the page and runs the game correctly.)  
